...
function displayPics(){
  ...
  // It gives us an error because when we declare using var inside a block statment we can use it globally, but when we declare inside a block statment we can't invoke it globally like we did usin console.
